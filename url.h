...
extern char browser[120];	/*!< a buffer that contains the name of the browser we should use */
...
extern char logo_link[128];		/*!< the link clicking the EL logo sends you to */
