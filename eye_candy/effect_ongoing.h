...
public:
enum OngoingType {
	OG_MAGIC_PROTECTION, OG_SHIELD, OG_MAGIC_IMMUNITY, OG_POISON, OG_HARVEST, };
OngoingEffect(EyeCandy *_base, bool *_dead, Vec3 *_pos, const color_t _hue_adjust, const color_t _saturation_adjust, const OngoingType _type, const Uint16 _LOD, const float _strength, Uint32 _buff_type);
~OngoingEffect();
