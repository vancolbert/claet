...
public:
enum BreathType {
	FIRE, ICE, POISON, MAGIC, LIGHTNING, WIND,
};
...
public:
BreathParticle(Effect *_effect, ParticleMover *_mover, const Vec3 _pos, const Vec3 _velocity, const coord_t _size, const alpha_t _alpha, const color_t red, const color_t green, const color_t blue, TextureEnum _texture, const Uint16 _LOD, const BreathEffect::BreathType _type);
~BreathParticle() {}
...
public:
BreathSmokeParticle(Effect *_effect, ParticleMover *_mover, const Vec3 _pos, const Vec3 _velocity, const coord_t _size, const alpha_t _alpha, TextureEnum _texture, const Uint16 _LOD, const BreathEffect::BreathType _type);
~BreathSmokeParticle() {}
virtual bool idle(const Uint64 delta_t);
virtual Uint32 get_texture();
