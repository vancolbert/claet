...
public:
InnerSummonParticle(Effect *_effect, ParticleMover *_mover, const Vec3 _pos, const Vec3 _velocity, const coord_t _size, const alpha_t _alpha, const color_t red, const color_t green, const color_t blue, TextureEnum _texture, const Uint16 _LOD);
~InnerSummonParticle() {}
virtual bool idle(const Uint64 delta_t);
virtual Uint32 get_texture();
virtual light_t estimate_light_level() const {
...
public:
enum SummonType {
	RABBIT, RAT, BEAVER, SKUNK, RACOON, DEER, GREEN_SNAKE, RED_SNAKE, BROWN_SNAKE, FOX, BOAR, WOLF, SPIDER, SKELETON, SMALL_GARGOYLE, MEDIUM_GARGOYLE, LARGE_GARGOYLE, PUMA, FEMALE_GOBLIN, POLAR_BEAR, BEAR, ARMED_MALE_GOBLIN, ARMED_SKELETON, FEMALE_ORC, MALE_ORC, ARMED_FEMALE_ORC, ARMED_MALE_ORC, TIGER, CYCLOPS, FLUFFY, GIANT_SNAKE, PHANTOM_WARRIOR, MOUNTAIN_CHIMERAN, YETI, ARCTIC_CHIMERAN, GIANT,
};
