 ...
 */
typedef enum {
	ift_rgba4 = 0, ift_rgb8, ift_r5g6b5, ift_rgba8, ift_bgr8, ift_bgra8, ift_rgb5_a1, ift_a8, ift_l8, ift_la8, ift_dxt1, ift_dxt3, ift_dxt5, ift_ati1, ift_ati2,
} image_format_type;
/**
 * supported texture compression formats.
 */
typedef enum {
	tct_s3tc = 0x01, tct_3dc = 0x02, tct_latc = 0x04,
