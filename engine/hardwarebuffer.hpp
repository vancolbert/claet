...
enum HardwareBufferAccessType {
	hbat_read_only = GL_READ_ONLY, hbat_read_write = GL_READ_WRITE, hbat_write_only = GL_WRITE_ONLY,
};
/**
 * @}
 */
...
enum HardwareBufferType {
	hbt_vertex = GL_ARRAY_BUFFER, hbt_index = GL_ELEMENT_ARRAY_BUFFER, hbt_pixel_pack = GL_PIXEL_PACK_BUFFER, hbt_pixel_unpack = GL_PIXEL_UNPACK_BUFFER,
};
/**
 * @}
 */
...
enum HardwareBufferUsageType {
	hbut_dynamic_copy = GL_DYNAMIC_COPY, hbut_dynamic_draw = GL_DYNAMIC_DRAW, hbut_dynamic_read = GL_DYNAMIC_READ, hbut_static_copy = GL_STATIC_COPY, hbut_static_draw = GL_STATIC_DRAW, hbut_static_read = GL_STATIC_READ, hbut_stream_copy = GL_STREAM_COPY, hbut_stream_draw = GL_STREAM_DRAW, hbut_stream_read = GL_STREAM_READ,
};
/**
 * @}
 */
 ...
 */
void set_size(const HardwareBufferType type, const Uint64 size, const HardwareBufferUsageType usage);
/**
 * Binds the buffer.
 ...
 */
static void *map(const HardwareBufferType type, const HardwareBufferAccessType access);
/**
