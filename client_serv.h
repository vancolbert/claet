...
typedef enum actor_types_type
{
    ...
    chimere_maudite = 96,
    orc_male_maudit = 97,
    orc_femelle_maudite = 98,
    orc_male_maudit_armed = 99,
    cyclopsmh = 100,
    cyclopsms = 101,
    orc_female_brigand = 102,
    ogre_male_dominant = 103,
    goblinm_assassin = 104,
    skeleton_decompo = 105,
    skeleton_rouille = 106,
    horse1 = 107,
    horse2 = 108,
    spider_veuve_noire = 109,
    lycaon = 110,
    sinan_female = 111,
    sinan_male = 112,
    elfe_noir_female = 113,
    elfe_noir_male = 114,
    vieux_troll = 115,
	chauve_souris = 116,
	mouette = 117,
