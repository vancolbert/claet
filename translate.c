...
void init_stats() {
	...
	add_xml_statid(nexus, "potion_nexus", &(attributes.potion_nexus), "Potion", "pot");
	add_xml_statid(nexus, "recolte_nexus", &(attributes.recolte_nexus), "Recolte", "rec");
	add_xml_statid(nexus, "fabrication_nexus", &(attributes.fabrication_nexus), "fabrication", "fab");
