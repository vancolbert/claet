 ...
 */
typedef enum {
	head_bone = 0, mouth_bone = 1, body_top_bone = 2, body_bottom_bone = 3, cape_top_bone = 4, cape_middle_bone = 5, cape_bottom_bone = 6, weapon_left_bone = 7, weapon_right_bone = 8, staff_right_bone = 9, arrow_bone = 10, hand_left_bone = 11, hand_right_bone = 12, highest_bone = 13,
} cal_bone_name;
