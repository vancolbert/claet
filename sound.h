 ...
 *
 *      Affiche les zones musicales sur les cartes
 *
 */
 ...
 *
 *      Affiche le contenu de la playlist en cours
 *
 */
 ...
 *
 *      Modifie l'ensemble de la playlist en cours afin de forcer une musique
 *
 */
