...
typedef enum {
	BPE_NONE, BPE_BOOK, BPE_PAGE, BPE_REF, BPE_BLOCK, BPE_IMAGE, BPE_TABLE, BPE_CAPTION, BPE_TR, BPE_TC, BPE_LABEL, BPE_TD, BPE_INLINE, BPE_TEXT, BPE_TITLE, BPE_COUNT,
} bp_Element;
/*! \name the xml attributes */
typedef enum {
	BPA_COLSPAN, BPA_ROWSPAN, BPA_NAME, BPA_TYPE, BPA_TO, BPA_ALIGN, BPA_COLOR, BPA_MARGIN, BPA_MARGIN_BEFORE, BPA_MARGIN_AFTER, BPA_MARGIN_START, BPA_MARGIN_END, BPA_BORDER, BPA_BORDER_BEFORE, BPA_BORDER_AFTER, BPA_BORDER_START, BPA_BORDER_END, BPA_BORDER_COLOR, BPA_BORDER_BEFORE_COLOR, BPA_BORDER_AFTER_COLOR, BPA_BORDER_START_COLOR, BPA_BORDER_END_COLOR, BPA_PADDING, BPA_PADDING_BEFORE, BPA_PADDING_AFTER, BPA_PADDING_START, BPA_PADDING_END, BPA_FONT_SIZE, BPA_ALIGNMENT, BPA_WORD_SPACING, BPA_MIN_WORD_SPACING, BPA_MAX_WORD_SPACING, BPA_LETTER_SPACING, BPA_MIN_LETTER_SPACING, BPA_MAX_LETTER_SPACING, BPA_WIDTH, BPA_HEIGHT, BPA_BACKGROUND, BPA_LAYOUT, BPA_BLOCK_PROGRESSION, BPA_INLINE_PROGRESSION, BPA_FONT_FACE, BPA_ROTATE, BPA_MIRROR, BPA_TEX_FILE, BPA_TEX_LEFT, BPA_TEX_RIGHT, BPA_TEX_TOP, BPA_TEX_BOTTOM, BPA_LINE_SPACING, BPA_COUNT,
}
bp_Attribute;
/*! \name display layout */
...
/*! \name text alignments */
typedef enum {
	BPAL_START, BPAL_END, BPAL_CENTER, BPAL_JUSTIFIED, BPAL_SPLIT, BPAL_COUNT,
} bp_Alignment;
