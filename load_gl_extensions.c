...
/*	GL_ARB_multitexture			*/
	...
	if (strstr(extensions_string, "GL_ARB_multitexture") != NULL && !multitexture_problem)
	{
		...
		if (e == GL_TRUE)
		{
			extensions |= 1ull << arb_multitexture;
...
/*	GL_ARB_texture_compression		*/
	if (strstr(extensions_string, "GL_ARB_texture_compression") != NULL)
	{
		...
		if (e == GL_TRUE)
		{
			extensions |= 1ull << arb_texture_compression;
		}
	}
/*	GL_ARB_texture_compression		*/
/*	GL_ARB_point_parameters			*/
	if (strstr(extensions_string, "GL_ARB_point_parameters") != NULL)
	{
		...
		if (e == GL_TRUE)
		{
			extensions |= 1ull << arb_point_parameters;
		}
	}
/*	GL_ARB_point_parameters			*/
/*	GL_ARB_point_sprite			*/
	...
	{
		extensions |= 1ull << arb_point_sprite;
	}
/*	GL_ARB_point_sprite			*/
/*	GL_ARB_vertex_buffer_object		*/
	if (strstr(extensions_string, "GL_ARB_vertex_buffer_object") != NULL)
	{
		...
		if (e == GL_TRUE)
		{
			extensions |= 1ull << arb_vertex_buffer_object;
		}
	}
/*	GL_ARB_vertex_buffer_object		*/
/*	GL_ARB_shadow				*/
...
/*	GL_ARB_occlusion_query			*/
	if (strstr(extensions_string, "GL_ARB_occlusion_query") != NULL)
	{
		...
		if (e == GL_TRUE)
		{
			extensions |= 1ull << arb_occlusion_query;
		}
	}
/*	GL_ARB_occlusion_query			*/
/*	GL_ARB_depth_texture			*/
	...
	{
		extensions |= 1ull << arb_depth_texture;
	}
/*	GL_ARB_depth_texture			*/
/*	GL_ARB_fragment_program			*/
	if (strstr(extensions_string, "GL_ARB_fragment_program") != NULL)
	{
		extensions |= 1ull << arb_fragment_program;
	}
/*	GL_ARB_fragment_program			*/
/*	GL_ARB_vertex_program			*/
	if (strstr(extensions_string, "GL_ARB_vertex_program") != NULL && !vertex_program_problem)
	{
		...
		if (e == GL_TRUE)
		{
			extensions |= 1ull << arb_vertex_program;
		}
	}
/*	GL_ARB_vertex_program			*/
/*	GL_ARB_fragment_shader			*/
	...
	{
		extensions |= 1ull << arb_fragment_shader;
	}
/*	GL_ARB_fragment_shader			*/
/*	GL_ARB_vertex_shader			*/
	if (strstr(extensions_string, "GL_ARB_vertex_shader") != NULL)
	{
		...
		if (e == GL_TRUE)
		{
			extensions |= 1ull << arb_vertex_shader;
		}
	}
/*	GL_ARB_vertex_shader			*/
/*	GL_ARB_shader_objects			*/
	if (strstr(extensions_string, "GL_ARB_shader_objects") != NULL)
	{
		...
		if (e == GL_TRUE)
		{
			extensions |= 1ull << arb_shader_objects;
		}
	}
/*	GL_ARB_shader_objects			*/
/*	GL_ARB_shading_language_100		*/
	...
	{
		extensions |= 1ull << arb_shading_language_100;
	}
/*	GL_ARB_shading_language_100		*/
	if (strstr(extensions_string, "GL_ARB_texture_non_power_of_two") != NULL)
	{
		extensions |= 1ull << arb_texture_non_power_of_two;
	}
/*	GL_EXT_compiled_vertex_array		*/
	if (strstr(extensions_string, "GL_EXT_compiled_vertex_array") != NULL)
	{
		...
		if (e == GL_TRUE)
		{
			extensions |= 1ull << ext_compiled_vertex_array;
		}
	}
/*	GL_EXT_compiled_vertex_array		*/
/*	GL_EXT_draw_range_elements		*/
	if (strstr(extensions_string, "GL_EXT_draw_range_elements") != NULL)
	{
		...
		if (e == GL_TRUE)
		{
			extensions |= 1ull << ext_draw_range_elements;
		}
	}
/*	GL_EXT_draw_range_elements		*/
/*	GL_EXT_framebuffer_object		*/
	if (strstr(extensions_string, "GL_EXT_framebuffer_object") != NULL)
	{
		...
		if (e == GL_TRUE)
		{
			extensions |= 1ull << ext_framebuffer_object;
		}
	}
/*	GL_EXT_framebuffer_object		*/
...
/*	GL_EXT_gpu_program_parameters	*/
	if (strstr(extensions_string, "GL_EXT_gpu_program_parameters") != NULL)
	{
		...
		if (e == GL_TRUE)
		{
			extensions |= 1ull << ext_gpu_program_parameters;
		}
	}
/*	GL_EXT_gpu_program_parameters	*/
}
...
{
	return (extensions & (1ull << extension)) != 0;
}
