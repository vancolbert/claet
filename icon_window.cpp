...
public:
Espace_Icon(int icon_id, int coloured_icon_id, const char *help_str, const char *the_key_name, const std::vector<CommandQueue::Line> *lines = 0)
	: Basic_Icon(icon_id, coloured_icon_id, help_str, lines) {}
~Espace_Icon(void) {}
};
...
private:
class Busy {public: Busy(void) {busy = true;}
~Busy(void) {busy = false;}};
