...
extern "C"
{
	...
	ec_reference ec_create_sword_emerald_claymore_lumiere(actor* _actor, int LOD);
	ec_reference ec_create_sword_cutlass_feu(actor* _actor, int LOD);
	ec_reference ec_create_sword_cutlass_glace(actor* _actor, int LOD);
	ec_reference ec_create_sword_cutlass_arcane(actor* _actor, int LOD);
	ec_reference ec_create_sword_cutlass_lumiere(actor* _actor, int LOD);
	ec_reference ec_create_sword_sunbreaker_feu(actor* _actor, int LOD);
	ec_reference ec_create_sword_sunbreaker_glace(actor* _actor, int LOD);
	ec_reference ec_create_sword_sunbreaker_arcane(actor* _actor, int LOD);
	ec_reference ec_create_sword_sunbreaker_lumiere(actor* _actor, int LOD);
	ec_reference ec_create_sword_orc_slayer_feu(actor* _actor, int LOD);
	ec_reference ec_create_sword_orc_slayer_glace(actor* _actor, int LOD);
	ec_reference ec_create_sword_orc_slayer_arcane(actor* _actor, int LOD);
	ec_reference ec_create_sword_orc_slayer_lumiere(actor* _actor, int LOD);
	ec_reference ec_create_sword_eagle_wing_feu(actor* _actor, int LOD);
	ec_reference ec_create_sword_eagle_wing_glace(actor* _actor, int LOD);
	ec_reference ec_create_sword_eagle_wing_arcane(actor* _actor, int LOD);
	ec_reference ec_create_sword_eagle_wing_lumiere(actor* _actor, int LOD);
	ec_reference ec_create_sword_jagged_saber_feu(actor* _actor, int LOD);
