...
Uint32 K_STOREALL=SDLK_F12;
Uint32 K_WITHDRAW_ITEMLIST=SDLK_F8;
...
static key_store_entry key_store[] =
{
	...
	{ "#K_MIXALL", &K_MIXALL },
	{ "#K_DROPALL", &K_DROPALL },
	{ "#K_STOREALL", &K_STOREALL },
	{ "#K_WITHDRAW_ITEMLIST", &K_WITHDRAW_ITEMLIST },
	{ "#K_SIGILS", &K_SIGILS },
