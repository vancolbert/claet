 ...
 *
 *      Récupère les différentes catégories existantes depuis la liste des connaissances (knowledge.lst) précédement chargées.
 *      Initialise les compteurs (présents/total) à zéro et affecte les noms correspondants
 *
 * \callgraph
 */
