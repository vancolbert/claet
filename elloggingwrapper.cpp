...
extern "C" void log_error(const char *file, const Uint32 line, const char *message, ...) {
	va_list ap;
	char err_msg[512];
	assert(message != 0);
...
extern "C" void log_warning(const char *file, const Uint32 line, const char *message, ...) {
	va_list ap;
	char err_msg[512];
	assert(message != 0);
	assert(strlen(message) > 0);
...
extern "C" void log_info(const char *file, const Uint32 line, const char *message, ...) {
	va_list ap;
	char err_msg[512];
	assert(message != 0);
	assert(strlen(message) > 0);
...
extern "C" void log_debug(const char *file, const Uint32 line, const char *message, ...) {
	va_list ap;
	char err_msg[512];
	assert(message != 0);
	assert(strlen(message) > 0);
...
extern "C" void log_debug_verbose(const char *file, const Uint32 line, const char *message, ...) {
	va_list ap;
	char err_msg[512];
	assert(message != 0);
	assert(strlen(message) > 0);
...
extern "C" void enter_debug_mark(const char *file, const Uint32 line, const char *name) {
	assert(name != 0);
	assert(strlen(name) > 0);
	el::enter_debug_mark(name, file, line);
}
extern "C" void leave_debug_mark(const char *file, const Uint32 line, const char *name) {
	assert(name != 0);
	assert(strlen(name) > 0);
