 ...
 */
void log_error(const char* file, const Uint32 line, const char* message, ...) CHECK_PRINTF(3);
 ...
 */
void log_warning(const char* file, const Uint32 line, const char* message, ...) CHECK_PRINTF(3);
 ...
 */
void log_info(const char* file, const Uint32 line, const char* message, ...) CHECK_PRINTF(3);
 ...
 */
void log_debug(const char* file, const Uint32 line, const char* message, ...) CHECK_PRINTF(3);
...
void log_debug_verbose(const char* file, const Uint32 line,
	const char* message, ...) CHECK_PRINTF(3);
