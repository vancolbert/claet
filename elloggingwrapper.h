...
#endif
typedef enum {
	llt_error = 0, llt_warning = 1, llt_info = 2, llt_debug = 3, llt_debug_verbose = 4,
} LogLevelType;
/**
 * @ingroup logging
 *
 ...
 */
void log_debug_verbose(const char *file, const Uint32 line, const char *message, ...);
/**
 * @ingroup logging
 *
 ...
 */
void enter_debug_mark(const char *file, const Uint32 line, const char *name);
/**
 * @ingroup logging
 *
 ...
 * @param name Name of the debug mark.
 */
void leave_debug_mark(const char *file, const Uint32 line, const char *name);
/**
 * @ingroup logging
 *
