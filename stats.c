...
void get_partial_stat(Uint8 name, Sint32 value) {
	switch (name) {
	case PHY_CUR:
		your_info.phy.cur = value;
		break;
	case PHY_BASE:
		your_info.phy.base = value;
		break;
	case COO_CUR:
		your_info.coo.cur = value;
		break;
	case COO_BASE:
		your_info.coo.base = value;
		break;
	case REAS_CUR:
		your_info.rea.cur = value;
		break;
	case REAS_BASE:
		your_info.rea.base = value;
		break;
	case WILL_CUR:
		your_info.wil.cur = value;
		break;
	case WILL_BASE:
		your_info.wil.base = value;
		break;
	case INST_CUR:
		your_info.ins.cur = value;
		break;
	case INST_BASE:
		your_info.ins.base = value;
		break;
	case VIT_CUR:
		your_info.vit.cur = value;
		break;
	case VIT_BASE:
	...
	case MIGHT_CUR:
		...
		break;
	case MIGHT_BASE:
		your_info.might.base = value;
		break;
	case MATTER_CUR:
		your_info.matter.cur = value;
		break;
	case MATTER_BASE:
		your_info.matter.base = value;
		break;
	case TOUGHNESS_CUR:
		your_info.tough.cur = value;
		break;
	case TOUGHNESS_BASE:
		your_info.tough.base = value;
		break;
	case CHARM_CUR:
		your_info.charm.cur = value;
		break;
	case CHARM_BASE:
		your_info.charm.base = value;
		break;
	case REACTION_CUR:
		your_info.react.cur = value;
		break;
	case REACTION_BASE:
		your_info.react.base = value;
		break;
	case PERCEPTION_CUR:
		your_info.perc.cur = value;
		break;
	case PERCEPTION_BASE:
		your_info.perc.base = value;
		break;
	case RATIONALITY_CUR:
		your_info.ration.cur = value;
		break;
	case RATIONALITY_BASE:
		your_info.ration.base = value;
		break;
	case DEXTIRITY_CUR:
		your_info.dext.cur = value;
		break;
	case DEXTIRITY_BASE:
		your_info.dext.base = value;
		break;
	case ETHEREALITY_CUR:
		your_info.eth.cur = value;
		break;
	case ETHEREALITY_BASE:
		your_info.eth.base = value;
		break;
	case DEFENSE_N_CUR:
		your_info.defense_nexus.cur = value;
		break;
	case DEFENSE_N_BASE:
		your_info.defense_nexus.base = value;
		break;
	case NECRO_N_CUR:
		your_info.necro_nexus.cur = value;
		break;
	case NECRO_N_BASE:
		your_info.necro_nexus.base = value;
		break;
	case POTION_N_CUR:
		your_info.potion_nexus.cur = value;
		break;
	case POTION_N_BASE:
		your_info.potion_nexus.base = value;
		break;
	case RECOLTE_N_CUR:
		your_info.recolte_nexus.cur = value;
		break;
	case RECOLTE_N_BASE:
		your_info.recolte_nexus.base = value;
		break;
	case FABRICATION_N_CUR:
		your_info.fabrication_nexus.cur = value;
		break;
	case FABRICATION_N_BASE:
		your_info.fabrication_nexus.base = value;
		break;
	case ARTISANAT_N_CUR:
		your_info.artisanat_nexus.cur = value;
		break;
	case ARTISANAT_N_BASE:
		your_info.artisanat_nexus.base = value;
		break;
	case MAGIE_N_CUR:
		your_info.magie_nexus.cur = value;
		break;
	case MAGIE_N_BASE:
		your_info.magie_nexus.base = value;
		break;
	case ALCHIMIE_N_CUR:
		your_info.alchimie_nexus.cur = value;
		break;
	case ALCHIMIE_N_BASE:
		your_info.alchimie_nexus.base = value;
		break;
	case ENGINEER_N_CUR:
		your_info.ingenierie_nexus.cur = value;
		break;
	case ENGINEER_N_BASE:
		your_info.ingenierie_nexus.base = value;
		break;
	case MAN_S_CUR:
		your_info.manufacturing_skill.cur = value;
		break;
	case MAN_S_BASE:
		...
		your_info.manufacturing_skill.base = value;
		break;
	case HARV_S_CUR:
		your_info.harvesting_skill.cur = value;
		break;
	case HARV_S_BASE:
		...
		your_info.harvesting_skill.base = value;
		break;
	case ALCH_S_CUR:
		your_info.alchemy_skill.cur = value;
		break;
	case ALCH_S_BASE:
		...
		your_info.alchemy_skill.base = value;
		break;
	case OVRL_S_CUR:
		your_info.overall_skill.cur = value;
		break;
	case OVRL_S_BASE:
		...
		your_info.overall_skill.base = value;
		break;
	case ATT_S_CUR:
		your_info.attack_skill.cur = value;
		break;
	case ATT_S_BASE:
		...
		your_info.attack_skill.base = value;
		break;
	case DEF_S_CUR:
		your_info.defense_skill.cur = value;
		break;
	case DEF_S_BASE:
		...
		your_info.defense_skill.base = value;
		break;
	case MAG_S_CUR:
		your_info.magic_skill.cur = value;
		break;
	case MAG_S_BASE:
		...
		your_info.magic_skill.base = value;
		break;
	case POT_S_CUR:
		your_info.potion_skill.cur = value;
		break;
	case POT_S_BASE:
		...
		your_info.potion_skill.base = value;
		break;
	case CARRY_WGHT_CUR:
		your_info.carry_capacity.cur = value;
		break;
	case CARRY_WGHT_BASE:
		your_info.carry_capacity.base = value;
		break;
	case MAT_POINT_CUR:
		your_info.material_points.cur = value;
		break;
	case MAT_POINT_BASE:
		your_info.material_points.base = value;
		break;
	case ETH_POINT_CUR: {
		char str[5];
	...
	case ETH_POINT_BASE:
		your_info.ethereal_points.base = value;
		break;
	case FOOD_LEV:
		your_info.food_level = value;
		break;
	case MAN_EXP:
		...
		break;
	case MAN_EXP_NEXT:
		your_info.manufacturing_exp_next_lev = value;
		break;
	case HARV_EXP:
		...
		break;
	case HARV_EXP_NEXT:
		your_info.harvesting_exp_next_lev = value;
		break;
	case ALCH_EXP:
		...
		break;
	case ALCH_EXP_NEXT:
		your_info.alchemy_exp_next_lev = value;
		break;
	case OVRL_EXP:
	...
	case DEF_EXP:
		...
		break;
	case DEF_EXP_NEXT:
		your_info.defense_exp_next_lev = value;
		break;
	case ATT_EXP:
		...
		break;
	case ATT_EXP_NEXT:
		your_info.attack_exp_next_lev = value;
		break;
	case MAG_EXP:
		...
		break;
	case MAG_EXP_NEXT:
		your_info.magic_exp_next_lev = value;
		break;
	case POT_EXP:
		...
		break;
	case POT_EXP_NEXT:
		your_info.potion_exp_next_lev = value;
		break;
	case SUM_EXP:
		...
		break;
	case SUM_EXP_NEXT:
		your_info.summoning_exp_next_lev = value;
		break;
	case SUM_S_CUR:
		your_info.summoning_skill.cur = value;
		break;
	case SUM_S_BASE:
		...
		your_info.summoning_skill.base = value;
		break;
	case CRA_EXP:
		...
		break;
	case CRA_EXP_NEXT:
		your_info.crafting_exp_next_lev = value;
		break;
	case CRA_S_CUR:
		your_info.crafting_skill.cur = value;
		break;
	case CRA_S_BASE:
		...
		your_info.crafting_skill.base = value;
		break;
	case ENG_EXP:
		...
		break;
	case ENG_EXP_NEXT:
		your_info.engineering_exp_next_lev = value;
		break;
	case ENG_S_CUR:
		your_info.engineering_skill.cur = value;
		break;
	case ENG_S_BASE:
		...
		your_info.engineering_skill.base = value;
		break;
	case NOTORIETE:
		your_info.notoriete = value;
		break;
	case RELIGION:
		your_info.religion = value;
		break;
	case RELIGION_LEV:
		your_info.niv_rel = value;
		break;
	case RACE:
		...
		break;
	case RESEARCHING:
		your_info.researching = value;
		break;
	case RESEARCH_COMPLETED:
		your_info.research_completed = value;
		break;
	case RESEARCH_TOTAL:
		your_info.research_total = value;
		break;
	default:
...
Sint16 get_base_might() {
	return (your_info.phy.base + your_info.coo.base) / 2;
}
Sint16 get_cur_might() {
	return (your_info.phy.cur + your_info.coo.cur) / 2;
}
Sint16 get_base_matter() {
	return (your_info.phy.base + your_info.wil.base) / 2;
}
Sint16 get_cur_matter() {
	return (your_info.phy.cur + your_info.wil.cur) / 2;
}
Sint16 get_base_tough() {
	return (your_info.phy.base + your_info.vit.base) / 2;
}
Sint16 get_cur_tough() {
	return (your_info.phy.cur + your_info.vit.cur) / 2;
}
Sint16 get_base_charm() {
	return (your_info.ins.base + your_info.vit.base) / 2;
}
Sint16 get_cur_charm() {
	return (your_info.ins.cur + your_info.vit.cur) / 2;
}
Sint16 get_base_react() {
	return (your_info.ins.base + your_info.coo.base) / 2;
}
Sint16 get_cur_react() {
	return (your_info.ins.cur + your_info.coo.cur) / 2;
}
Sint16 get_base_perc() {
	return (your_info.ins.base + your_info.rea.base) / 2;
}
Sint16 get_cur_perc() {
	return (your_info.ins.cur + your_info.rea.cur) / 2;
}
Sint16 get_base_rat() {
	return (your_info.wil.base + your_info.rea.base) / 2;
}
Sint16 get_cur_rat() {
	return (your_info.wil.cur + your_info.rea.cur) / 2;
}
Sint16 get_base_dext() {
	return (your_info.coo.base + your_info.rea.base) / 2;
}
Sint16 get_cur_dext() {
	return (your_info.coo.cur + your_info.rea.cur) / 2;
}
Sint16 get_base_eth() {
	return (your_info.wil.base + your_info.vit.base) / 2;
}
Sint16 get_cur_eth() {
	return (your_info.wil.cur + your_info.vit.cur) / 2;
}
